...
setup(
    ...
    description="""ape-beacon: Beacon Provider plugin for Ethereum-based networks""",
    ...
    install_requires=[
        ...
        "responses",  # Use for beacon provider local tests
        "types-requests",
    ],
    ...
    package_data={"ape_beacon": ["py.typed"]},
    classifiers=[
